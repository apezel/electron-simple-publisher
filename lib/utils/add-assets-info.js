...
const ASSETS_DATA = {
  ...
  // 'win32-x64': {
  //   install: [
  //     path.join('squirrel.windows', 'x64', '{productName}-{version} Setup.exe'),
  //     path.join('win', '{productName} Setup {version}.exe')
  //   ],
  //   metaFile: path.join('win', 'RELEASES'),
  //   update: [
  //     path.join('squirrel.windows', 'x64', '{name}-{version}-full.nupkg'),
  ...
  'win32-x64': {
    ...
    metaFile: path.join('squirrel.windows', 'x64', 'RELEASES'),
    update: [
      path.join('squirrel.windows', 'x64', '{name}-{version}-full.nupkg')
    ]
  }
